        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Card className="mb-8">
            <CardHeader>
              ...
              <CardDescription>
                Manage your projects, generate social media content, and track your analytics.
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-[250px_1fr] gap-8">
            ...
            <Card className="h-fit">
              <CardContent className="p-4">
                <Tabs 
                  ...
                  className="w-full"
                >
                  <TabsList className="flex flex-col items-start h-auto gap-2">
                    ...
                    <TabsTrigger value="projects" className="w-full justify-start">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 mr-2">
                    ...
                    <TabsTrigger value="social-media" className="w-full justify-start">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 mr-2">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 100 2.186m0-2.186c.18.324.283.696.283 1.093s-.103.77-.283 1.093m0-2.186l9.566-5.314m-9.566 7.5l9.566 5.314m0 0a2.25 2.25 0 103.935 0m-3.935 0l-9.566-5.314m9.566-2.186a2.25 2.25 0 10-3.935 0" />
                      </svg>
                    ...
                    {isAdmin && (
                      <TabsTrigger value="admin" className="w-full justify-start">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 mr-2">
            ...
            <div>
              ...
              {activeTab === "social-media" && <SocialMediaGenerator />}
              {activeTab === "analytics" && (
                <Card>
                  <CardHeader>
