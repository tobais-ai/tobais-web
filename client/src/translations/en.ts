export const enTranslations = {
  ...
  checkout: {
    ...
    pleaseSelectService: "Please select a service from our services page to continue.",
    noInvoicesSelected: "No Invoices Selected",
    pleaseSelectInvoices: "Please return to your dashboard and select invoices to pay.",
    browseServices: "Browse Services",
    backToDashboard: "Back to Dashboard",
    paymentInformation: "Payment Information",
    orderSummary: "Order Summary",
    invoiceSummary: "Invoice Summary",
    invoiceSummaryDesc: "You are about to pay {count} selected invoice(s).",
